  ...
  return (
    <div className="space-y-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          <div className="text-[10px] font-mono text-[#6a6c5d] uppercase tracking-wider mb-1.5">
            cURL
          </div>
          <DocsCodeBlock code={curl} lang="bash" />
        </div>
        <div>
          <div className="text-[10px] font-mono text-yellow-500 uppercase tracking-wider mb-1.5">
            fidscript CLI
          </div>
