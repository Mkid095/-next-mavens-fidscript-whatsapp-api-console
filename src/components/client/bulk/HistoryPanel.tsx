        ...
        >
          <div className="flex items-start justify-between mb-1">
            ...
            <div className="flex items-center gap-1 shrink-0 ml-2">
              ...
              <button
                ...
                className="w-6 h-6 rounded-lg hover:bg-[#2d2813] flex items-center justify-center"
                title="Duplicate"
              >
              ...
              <button
                ...
                className="w-6 h-6 rounded-lg hover:bg-red-900/30 flex items-center justify-center"
                title="Delete"
              >
          ...
          <div className="flex items-center gap-3 mt-1.5 text-[9px] text-[#6e684a]">
            ...
            {campaign.delivered_count > 0 && (
              <>
                <span>•</span>
                <span className="text-green-400">{campaign.delivered_count} delivered</span>
              </>
            )}
          </div>
        </div>
