...
const mainActions: QuickAction[] = [
  {
    ...
    label: 'Buy Tokens',
    sublabel: 'Top up your balance',
    path: '/client/token-store',
    accent: true,
  },
  {
    icon: <MessageSquare size={18} />,
    label: 'Add Container',
    sublabel: 'Connect WhatsApp',
    path: '/client/whatsapp',
  },
  {
    icon: <Megaphone size={18} />,
    label: 'Create Campaign',
    sublabel: 'Bulk send messages',
    path: '/client/campaigns',
  },
  {
    icon: <Send size={18} />,
    label: 'Send Message',
    sublabel: 'Individual or group',
    path: '/client/messages',
  },
  {
    icon: <Bot size={18} />,
    label: 'Create Chatbot',
    sublabel: 'AI-powered replies',
    path: '/client/chatbots/new',
  },
  {
    icon: <Zap size={18} />,
    label: 'API Sandbox',
    sublabel: 'Test endpoints live',
    path: '/client/sandbox',
  },
];
...
const secondaryActions: QuickAction[] = [
  {
    ...
    sublabel: 'Import or export',
    path: '/client/contacts',
  },
  {
    icon: <FileText size={18} />,
    label: 'Documentation',
    sublabel: 'API reference & guides',
    path: '/client/docs',
  },
  {
    ...
    >
      <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
        action.accent
          ...
          : 'bg-[#2d2813] text-[#a8a99e] group-hover:text-[#eab308]'
      }`}>
        {action.icon}
      </div>
      <div>
