...
import { buildCodeSnippet, METHOD_COLORS, ParamTable, LangTabs } from './shared.js';
...
export interface DocsApiRefContentProps {
  endpoint: {
    method: string;
    path: string;
    name: string;
...
export function DocsApiRefContent({ endpoint, lang, setLang }: DocsApiRefContentProps) {
  if (!endpoint) return (
