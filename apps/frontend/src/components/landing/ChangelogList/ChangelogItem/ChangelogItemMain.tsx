...
import { Sparkles, Wrench, GitCommit, ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className={`absolute left-2 top-5 w-4 h-4 rounded-full border-2 ${
        isLatest ? 'bg-yellow-500 border-yellow-500 shadow-[0_0_0_4px_rgba(234,179,8,0.15)]' : 'bg-[#0c0b06] border-[#383416]'
      }`} />
      ...
      <div className={`bg-[#11110a] border rounded-2xl p-5 ${
        ...
        <h3 className="text-base font-semibold text-[#cbd3cf] mb-4 leading-snug">{entry.title}</h3>
