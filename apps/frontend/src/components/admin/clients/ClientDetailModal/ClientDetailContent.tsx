...
import { Mail, Phone, Building, Calendar, Shield, Coins, RefreshCw, ToggleLeft, ToggleRight, Smartphone } from 'lucide-react';
...
export function ClientDetailContent({ client, onToggle, onResetKey, onAwardTokens }: ClientDetailContentProps) {
