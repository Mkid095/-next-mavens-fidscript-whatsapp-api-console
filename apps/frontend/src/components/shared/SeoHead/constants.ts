import type { PageSchema } from './SeoHead';

export const BASE_URL = 'https://whatsapp.fidscript.com';
export const SITE_NAME = 'FIDScript WhatsApp API';
...
// ─── Props type (re-exported here so consumers only need this file) ────────────
...
// ─── SoftwareApplication schema (always injected) ──────────────────────────────
