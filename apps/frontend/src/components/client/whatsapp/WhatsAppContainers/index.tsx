...
import { useInstanceConnectionImpl as useInstanceConnection } from '../useInstanceConnection';
...
export default function WhatsAppContainers({
  ...
  } = useInstanceConnectionImpl({ instances, onInstancesChange });
    ...
    <div className="space-y-6">
      <div className="bg-[#1a1915] border border-[#2d2813] rounded-3xl p-5 shadow-sm">
        ...
        <ContainerGrid
          ...
          onCreateNew={() => setShowNewInstanceModal(true)}
        />
      </div>
