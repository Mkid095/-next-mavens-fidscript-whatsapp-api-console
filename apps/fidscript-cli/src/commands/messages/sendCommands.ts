...
import { loadJson, SendResponse } from './sendInputs.js';

/**
 * POST to a message endpoint and handle output / errors.
 * Exits process on authentication failure or send failure.
 */
